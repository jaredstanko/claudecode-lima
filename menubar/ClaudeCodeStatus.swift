...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func setupMenu() {
        ...
        newSessionMenuItem = NSMenuItem(title: "New Claude Code Session...", action: #selector(newSession), keyEquivalent: "n")
        ...
        // Open Portal
        let webItem = NSMenuItem(title: "Open Portal", action: #selector(openPortal), keyEquivalent: "w")
        webItem.target = self
        ...
        // Quit
        let quitItem = NSMenuItem(title: "Quit ClaudeCode-Status", action: #selector(quitApp), keyEquivalent: "q")
    ...
    private func updateIcon() {
        ...
        if let cached = cachedSymbols[symbolName] {
            symbol = cached
        } else if let img = NSImage(systemSymbolName: symbolName, accessibilityDescription: "Claude Code VM") {
            img.isTemplate = true
    ...
    @objc private func openTerminal() {
        ...
        openKittyTab(title: "Claude Code Shell", args: [
    ...
    @objc private func newSession() {
        let shell = getUserShell()
        openKittyTab(title: "Claude Code", args: [
            "limactl", "shell", "--workdir", "/home/claude", vmName, "--", shell, "-lc", "claude"
        ])
    }
    ...
    private let launchAgentLabel = "com.claudecode.status"
